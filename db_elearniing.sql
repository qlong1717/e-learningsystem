...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2022 at 06:44 PM
...
(20220003, 6, 'Long ??p trai quá ?úng không?', '?úng', 'Ch?n A', 'A sai, B ?úng', 'C? 3 ý trên', 'D', '0000-00-00');
...
(3, 'Fuk', 'Go', 'VietName', '0774277310', 'fukgo123', '7c4a8d09ca3762af61e59520943dc26494f8941b');
...
(3, 20220003, 0, 1, 'Long ??p trai quá ?úng không?', '?úng', 'Ch?n A', 'A sai, B ?úng', 'C? 3 ý trên', 'D'),
(4, 20220003, 0, 2, 'Long ??p trai quá ?úng không?', '?úng', 'Ch?n A', 'A sai, B ?úng', 'C? 3 ý trên', 'D');
...
(1, 'Long Pham', 'longadmin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Administrator');
...
--
ALTER TABLE `tblexercise`
  MODIFY `ExerciseID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20220004;
...
--
ALTER TABLE `tblstudentquestion`
  MODIFY `SQID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

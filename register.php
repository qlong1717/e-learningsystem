...
<head>
    ...
    <!-- Title Page-->
    <title>Đăng ký | English Pro</title>
                        ...
                        <form method="POST" action="register.php">
                            <div class="login-right-customer-bottom">
                                ...
                                <div class="input-login">
                                    <p>Họ</p>
                                    <input class="input--style-1" type="text" placeholder="Nhập họ của bạn" name="FNAME">
                                    <!-- <i class="fas fa-arrow-left"></i> -->
                                </div>

                                <div class="input-login">
                                    <p>Tên</p>
                                    <input class="input--style-1" type="text" placeholder="Nhập tên của bạn" name="LNAME">
                                </div>
                                ...
                                <div class="input-login">
                                    <p>Số điện thoại</p>
                                    <input class="input--style-1" type="number" placeholder="Nhập SDT của bạn" name="PHONE">
                                </div>
                                ...
                                <div class="submit-login-button">
                                    <a type="submit" name="btnRegister">
                                        <button class="btn btn--radius btn--green" type="submit" name="btnRegister"> 
                                    ...
                                    <a href="login.php"> Back to Login
                                    </a>
                                </div>
